...
\vspace*{1em}
  \begin{itemize}
  \item PyNE is intended as a \textit{library of composable tools} that is used to build nuclear science and engineering applications.
  \item It is \textit{permissively licensed} (2-clause BSD)
  \item It supports both a \textit{C++ and a Python} API.
