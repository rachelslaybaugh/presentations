...
\begin{frame}{What are the Goals of PyNE?}
    ...
    \begin{column}{0.45\textwidth}
 	...
 	\begin{column}{0.45\textwidth}
 	   \begin{center}
 	   \begin{figure}
 	   \includegraphics[height=1.25in,clip]{../2014-10-norcalANS/data-sources-thumb}  \\
       \includegraphics[height=1.25in,clip]{../2014-10-norcalANS/half-life-thumb}
	   \end{figure}
 	   \end{center}
  	\end{column}
	\end{columns}
...
\begin{frame}[allowframebreaks]{References}
	...
	\bibliography{../2014-PyNEforData/2014-PyNEforData}
\end{frame}
