  ...
  \frametitle{Challenges}
	...
	\begin{columns}
  	...
  	\begin{center}
		...
		\item Capturing angular behavior will alleviate this issue
		\end{itemize}
	\end{center}
  	\end{column}
 	%
...
\begin{frame}[fragile]
  ...
  \hspace*{3em} Limited Success}
	...
	\begin{itemize}
	\item Automatic WW generator \cite{MCNP2008}
...
\vspace*{1 em}
\textit{Better hybrid methods are needed}; two ideas.
...
\begin{frame}[fragile]
  \frametitle{Integration weighting}
    ...
    Different integration plan effectively capture angles in scalar flux creation	
	\begin{align*}
	...
	\item How sensitive to the quality of the discrete ordinates calculation?
	\item More, less, or differently sensitive to ray effects?
	\end{enumerate}
...
\begin{frame}[fragile]
  \frametitle{Lagrange discrete ordinate equations}
    ...
    with Cory Ahrens from Colorado School of Mines
	\begin{itemize}
...
\begin{frame}[fragile]
  \frametitle{Better hybrid methods are needed}
    ...
    \item The space- and energy-dependent importance map will be normalized and 
     source biasing parameters will be generated in a manner the same ways as
     the current implementation of hybrid methods \vspace*{1 em}
