...
\begin{frame}{Motivation}
	...
	locations throughout their histories}
		\begin{itemize}
		\pause
		\item{WARP, originally developed at UC Berkeley, employs ray tracing \cite{warp2015}}
		\end{itemize}
	\pause
...
\begin{frame}{WARP \cite{warp2015}}
	\begin{itemize}
	\pause
...
% --------------------------------------------------------------
\begin{frame}{Ray Tracing in WARP \cite{warp2015}}
	\begin{itemize}
	\pause
	...
	\item{OptiX is a highly-optimized, scalable framework developed for building applications on GPUs}
		...
		combined with a CUDA C-based programming system that handles the rays \cite{optix_man}}
		\end{itemize}
	\end{itemize}
\end{frame}
...
% --------------------------------------------------------------
\begin{frame}{Virtual Collisions and the Majorant Cross Section \cite{serp_delta}}
	\begin{itemize}
	\pause
...
% --------------------------------------------------------------
\begin{frame}{More on the Majorant \cite{serp_delta}}
	\begin{equation*}
        \begin{aligned}
        \Sigma_{maj}(E) &= \Sigma'_{tot,1}(E) = \Sigma'_{tot,2}(E) = \ldots = \Sigma'_{tot,M}(E) \\
        & = \max\{\Sigma_{tot,1}(E), \Sigma_{tot,2}(E),\ldots, \Sigma_{tot,M}(E)\}
...
% --------------------------------------------------------------
\begin{frame}{Advantages of Delta-tracking \cite{serp_delta}}
	\begin{itemize}
	\pause
...
% --------------------------------------------------------------
\begin{frame}{Disadvantages of Delta-tracking \cite{serp_delta}}
	\begin{itemize}
	\pause
...
\begin{frame}{Heterogeneous Geometry Configurations}
	...
	\item{Long-term interest is in cases where delta-tracking is faster than ray tracing on CPUs}
		\begin{itemize}
		\pause
		\item{Heterogeneous geometry configurations \cite{serp_delta}}
		\end{itemize}
	\pause
