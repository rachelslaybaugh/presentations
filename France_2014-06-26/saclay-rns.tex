...
\begin{frame}[fragile]
  \frametitle{Problem Investigation}
  	...
  	\begin{figure}
  		\includegraphics[height=2.5in,clip]{plate-geometry}
	...
	\item Processed by TRANSX (multi-group)
	\end{itemize}
  	\end{column}
	\end{columns}
...
\begin{frame}[fragile]
 ...
 \begin{figure}[p]
   \begin{center}
     \includegraphics[height=2.25 in,clip]{NSE13-109R1-PlateDRandRE}
   \end{center}
...
\begin{frame}[fragile]
 ...
 \begin{figure}[p]
   \begin{center}
     \includegraphics[height=2.25 in,clip]{NSE13-109R1-NoPlateDRandRE}
   \end{center}
...
\begin{frame}[fragile]
 ...
 \begin{figure}[p]
   \begin{center}
     \includegraphics[width=4in,clip]{NSE13-109R1-PlateREExcel}
   \end{center}
...
% \begin{figure}[p]
%   \begin{center}
%     \includegraphics[width=4in,clip]{NSE13-109R1-NoPlateREExcel}
%   \end{center}
...
% \begin{figure}[p]
%   \begin{center}
%     \includegraphics[width=2in,clip]{NSE13-109R1-ChordLength}
%   \end{center}
...
\begin{frame}[fragile]
  ...
  \begin{itemize}
  \item Also ran problem with and without the plate in MAVRIC (a multi-group MC code in SCALE using FW-CADIS)
...
\begin{frame}[fragile]
  ...
  \item Caused by multi-group cross sections in angle-independent implementation
