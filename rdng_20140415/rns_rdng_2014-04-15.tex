...
Birth weights match weight windows, making this the \underline{Consistent} \underline{A}djoint \underline{D}riven \underline{I}mportance \underline{S}ampling \underline{M}ethod
...
\item In this case the adjoint source needs to be a global forward solution
\end{itemize}
%
\begin{columns}
  \begin{column}{0.5\textwidth}
